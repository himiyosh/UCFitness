...
// ⚡ Bolt Optimization: Wrapped UserAvatar in React.memo()
// This prevents O(N) full-grid re-renders in components like AnimatedLeaderboard that map rows inline,
// improving interaction performance (e.g., hover effects) when rendering dense lists of users.
