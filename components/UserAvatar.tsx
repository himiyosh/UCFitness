...
// ⚡ Bolt: Wrapped UserAvatar in React.memo to prevent unnecessary re-renders
// in heavy list components (like DynamicLeaderboard, FollowingPanel) when
// parent states (like hover) change but props remain identical.
