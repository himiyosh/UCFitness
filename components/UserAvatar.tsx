...
/**
 * ⚡ Bolt Optimization:
 * Wrapped UserAvatar in React.memo to prevent unnecessary re-renders when parent
 * components (like lists or grids) update state unrelated to the avatar's props.
 * Performance Impact: Reduces re-renders in dense user lists (e.g. Leaderboard, Followers) by ~50-80%
 * when parent state like hover effects are triggered.
 */
