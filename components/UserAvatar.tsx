...
// ⚡ Bolt: Wrapped UserAvatar in React.memo to prevent unnecessary re-renders when parent lists (e.g., AnimatedLeaderboard) re-render due to hover state changes.
