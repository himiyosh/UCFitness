...
// ⚡ Bolt Optimization: Wrapped primitive UserAvatar in React.memo
// Why: Prevents unnecessary O(N) DOM diffing and re-renders when parent lists (like AnimatedLeaderboard)
// experience state changes (e.g. hover effects) but the avatar props remain identical.
