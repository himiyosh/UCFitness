...
// ⚡ Bolt Optimization: Wrapped deeply nested primitive component in React.memo()
// This prevents O(N) re-renders in inline list maps (like AnimatedLeaderboard)
// caused by minor parent state changes (e.g. hover interactions)
