...
// ⚡ Bolt: Wrapped in React.memo to prevent O(N) re-renders in heavy list components
// (e.g. AnimatedLeaderboard, DashboardFollowing) when parent state changes but props remain identical.
