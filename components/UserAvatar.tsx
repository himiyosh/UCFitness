...
// ⚡ Bolt Optimization: Wrapped in React.memo() to prevent unnecessary re-renders in deeply nested list maps (e.g. leaderboards) when parent states (like hover) change.
