...
// ⚡ Bolt: Added React.memo to prevent unnecessary re-renders in heavy list components (e.g. AnimatedLeaderboard)
// when parent state changes (like hovering) but avatar props remain identical.
