...
const EMOJIS = [
  ...
  { emoji: '⚡', size: 'text-2xl', left: '13%', top: '7%',  anim: 'animate-float' },
  ...
  { emoji: '💫', size: 'text-2xl', left: '95%', top: '18%', anim: 'animate-float-delayed' },
  { emoji: '✨', size: 'text-2xl', left: '48%', top: '25%', anim: 'animate-float' },
  ...
  { emoji: '🏆', size: 'text-2xl', left: '17%', top: '52%', anim: 'animate-float-delayed' },
  { emoji: '👟', size: 'text-2xl', left: '61%', top: '38%', anim: 'animate-float' },
  ...
  { emoji: '💪', size: 'text-2xl', left: '3%',  top: '74%', anim: 'animate-float' },
  { emoji: '🎉', size: 'text-3xl', left: '47%', top: '68%', anim: 'animate-float-delayed' },
  { emoji: '🏃', size: 'text-2xl', left: '76%', top: '58%', anim: 'animate-float' },
  { emoji: '✨', size: 'text-2xl', left: '92%', top: '65%', anim: 'animate-float-delayed' },
  ...
  { emoji: '⚡', size: 'text-2xl', left: '22%', top: '86%', anim: 'animate-float-delayed' },
  { emoji: '🎯', size: 'text-2xl', left: '85%', top: '87%', anim: 'animate-float' },
  { emoji: '👟', size: 'text-2xl', left: '42%', top: '93%', anim: 'animate-float-delayed' },
  { emoji: '🔥', size: 'text-2xl', left: '68%', top: '15%', anim: 'animate-float' },
  { emoji: '💫', size: 'text-2xl', left: '36%', top: '56%', anim: 'animate-float-delayed' },
  { emoji: '🎯', size: 'text-2xl', left: '9%',  top: '38%', anim: 'animate-float' },
];
