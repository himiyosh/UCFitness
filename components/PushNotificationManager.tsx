    ...
    return (
        <div className="w-full">
            <p className="text-xs text-gray-500 font-medium mb-4">
                Receive alerts when you earn new badges.
            </p>
            ...
            {!subscription ? (
                <button
                    ...
                    disabled={loading}
                    className="w-full px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg text-sm font-bold transition-all shadow-sm hover:shadow-md disabled:opacity-50 flex items-center justify-center gap-2"
                >
                    {loading ? (
                        <>
            ...
            {message && (
                <p className={`mt-3 text-xs font-medium text-center ${message.includes('Failed') ? 'text-red-500' : 'text-green-600'}`}>
                    {message}
                </p>
            )}
        </div>
