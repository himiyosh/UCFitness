        ...
        <div className="min-h-screen bg-indigo-50 flex flex-col items-center justify-center relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-4xl px-6 text-center">
                ...
                <p className="text-xl sm:text-2xl text-gray-600 mb-12 max-w-2xl mx-auto font-medium leading-relaxed">
                    {t('subtitle')}
                    <br />
                    <span className="text-indigo-600 font-bold">{t('compete')}</span>, <span className="text-purple-600 font-bold">{t('collectBadges')}</span>, {t.rich('stayActive', { span: (chunks) => <span className="text-indigo-600 font-bold">{chunks}</span> })}
                </p>
