                    ...
                    {TABS.map((tab) => {
                        ...
                        return (
                            <button
                                ...
                                className={`relative z-10 px-4 py-1.5 text-sm font-semibold rounded-md transition-all duration-200 cursor-pointer ${!isMidnight ? (isActive ? 'bg-[var(--theme-primary)] text-white shadow-md' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100') : ''}`}
                                style={isMidnight ? {
