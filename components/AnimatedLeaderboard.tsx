                    ...
                    {TABS.map((tab) => {
                        ...
                        return (
                            <button
                                ...
                                className={`relative z-10 px-4 py-0.5 text-sm font-semibold rounded-md transition-all duration-200 cursor-pointer sm:max-w-24 text-center ${!isMidnight ? (isActive ? 'bg-[var(--theme-primary)] text-white shadow-md' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-100') : ''}`}
                                style={isMidnight ? {
