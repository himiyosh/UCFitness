            ...
            <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="flex items-center justify-between mb-8">
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold text-white bg-[var(--theme-primary)] hover:opacity-90 transition-opacity shadow-md shadow-[var(--theme-primary)]/20"
                    >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
