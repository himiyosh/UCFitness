...
- Dashboard回帰テストはbonus-only報酬失敗からのretry、商品loaded状態、Price/Delivery非表示、有限画像fallback、表示したA/B treatmentと計測値の一致、LoginBonus閉鎖、375/1280pxの44px操作領域と横overflowを検査
