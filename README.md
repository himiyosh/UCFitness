...
- **GROUP Challenge認可契約**: public閲覧と参加を分離し、join/progress/leaveは現group member、PUTはcreatorかつ現OWNER/ADMINだけを許可する。進捗は現group member参加者の正歩数だけを合計し、DB障害や1000件超を0・未所属へ偽装しない
